using FlightTicketsSystem_FrontOffice.Web.Data;
...
namespace FlightTicketsSystem_FrontOffice.Web.Helpers
{
    public class UserHelper : IUserHelper
    {
        ...
        IEnumerable<SelectListItem> IUserHelper.GetComboRoles()
        {
